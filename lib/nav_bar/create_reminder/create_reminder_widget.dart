...
import 'create_reminder_model.dart';
export 'create_reminder_model.dart';

class CreateReminderWidget extends StatefulWidget {
  const CreateReminderWidget({super.key});
...
class _CreateReminderWidgetState extends State<CreateReminderWidget> {
  late CreateReminderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateReminderModel());
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                FFLocalizations.of(context).getText(
                  '2e684gla' /* Please fill out the form below... */,
                ),
