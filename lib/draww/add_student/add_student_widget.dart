...
import 'add_student_model.dart';
export 'add_student_model.dart';
                                            ...
                                            children: [
                                              Flexible(
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'vta45j8l' /* Email or Phone Number */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        'g0v44jbd' /* Enter your email or phone numb... */,
                                                      ),
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
