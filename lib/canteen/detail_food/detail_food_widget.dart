...
class _DetailFoodWidgetState extends State<DetailFoodWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailFoodModel());
  }
                                                      ...
                                                      children: [
                                                        TextSpan(
                                                          text: FFLocalizations
                                                                  .of(context)
                                                              .getText(
                                                            'pmpuc2wi' /* Kimbap is a popular Korean dis... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelMedium
                                                      ...
                                                      children: [
                                                        TextSpan(
                                                          text: FFLocalizations
                                                                  .of(context)
                                                              .getText(
                                                            'b6kmz9rt' /* The kimbap at USTH canteen is ... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelMedium
